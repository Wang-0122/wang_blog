package com.wang.wangblog.service.impl;

import com.wang.wangblog.dao.*;
import com.wang.wangblog.model.Blog;
import com.wang.wangblog.model.BlogCategory;
import com.wang.wangblog.model.BlogTag;
import com.wang.wangblog.model.BlogTagRelation;
import com.wang.wangblog.model.Vo.BlogDetailVO;
import com.wang.wangblog.model.Vo.BlogListVO;
import com.wang.wangblog.model.Vo.SimpleBlogListVO;
import com.wang.wangblog.service.BlogService;
import com.wang.wangblog.utils.MarkDownUtil;
import com.wang.wangblog.utils.PageQueryUtil;
import com.wang.wangblog.utils.PageResult;
import com.wang.wangblog.utils.PatternUtil;
...
public class BlogServiceImpl implements BlogService {
    ...
    public PageResult getBlogsForIndexPage(int page) {
        ...
        if (blogListVOS != null && !blogListVOS.isEmpty()){
            for (int i = 0 ; i < blogListVOS.size(); i ++) {
                BlogListVO vo = blogListVOS.get(i);
                vo.setDemoNum("demo0" + (i+1));
            }
        }
        int total = blogMapper.getTotalBlogs(pageUtil);
