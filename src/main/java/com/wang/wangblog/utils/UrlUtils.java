...
public final class UrlUtils {
	...
	public static String buildFullRequestUrl(String scheme, String serverName, int serverPort, String requestURI,
		...
		// Use the requestURI as it is encoded (RFC 6) and hence suitable for
		// redirects.
	 ...
	 * are (SEC-5).
	 * This method is typically used to return a URL for matching against
	 * secured paths, hence the decoded form is
	 * used in preference to the requestURI for building the returned value. But
	 * this method may also be called using
	 * dummy request objects which just have the requestURI and contextPatth
	 * set, for example, so it will fall back to
	 * using those.
	 * 
